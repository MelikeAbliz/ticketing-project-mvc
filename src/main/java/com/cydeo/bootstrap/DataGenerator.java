...
//        this run method will execute FIRST BEFORE EVERYTHING when you start Application
...
//rs.save(adminRole);//tightly coupling IOC
        ...
        UserDTO user2 = new UserDTO("Delisa",
                "Norre", "delisa@cydeo.com", "Abc3","Abc3", true, "8567412358", managerRole, Gender.FEMALE);
        UserDTO user3 = new UserDTO("Craig", "Jark",
                "craig@cydeo.com", "Abc4","Abc4", true, "7777775566", employeeRole, Gender.MALE);
        UserDTO user4 = new UserDTO("Shaun",
                "Hayns", "shaun@cydeo.com", "Abc5","Abc5", true, "3256987412", managerRole, Gender.MALE);
        UserDTO user6 = new UserDTO("Elizebeth",
                "Loren", "elizebeth@cydeo.com", "Abc6", "Abc6",true, "5306987412", employeeRole, Gender.FEMALE);
        UserDTO user7 = new UserDTO("Maria",
                "Ada", "maria@cydeo.com", "Abc7", "Abc7",true, "9996987412", employeeRole, Gender.FEMALE);
        UserDTO user8 = new UserDTO("Bill",
                "Matt", "bill@cydeo.com", "Abc8","Abc8", true, "8881239846", employeeRole, Gender.MALE);
